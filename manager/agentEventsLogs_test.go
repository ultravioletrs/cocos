...
func TestComputationIDFromAddress(t *testing.T) {
	ms := &managerService{
		vms: map[string]vm.VM{
			"comp1": qemu.NewVM(qemu.Config{VSockConfig: qemu.VSockConfig{GuestCID: 3}}, func(event vm.EventsLogs) error { return nil }, "comp1"),
			"comp2": qemu.NewVM(qemu.Config{VSockConfig: qemu.VSockConfig{GuestCID: 5}}, func(event vm.EventsLogs) error { return nil }, "comp2"),
		},
	}

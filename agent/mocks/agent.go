...
// Attestation provides a mock function with given fields: ctx, reportData, attType
func (_m *Service) Attestation(ctx context.Context, reportData [64]byte, attType int32) ([]byte, error) {
	ret := _m.Called(ctx, reportData, attType)
	...
	var r0 []byte
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, [64]byte, int32) ([]byte, error)); ok {
		return rf(ctx, reportData, attType)
	}
	if rf, ok := ret.Get(0).(func(context.Context, [64]byte, int32) []byte); ok {
		r0 = rf(ctx, reportData, attType)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]byte)
		}
	...
	if rf, ok := ret.Get(1).(func(context.Context, [64]byte, int32) error); ok {
		r1 = rf(ctx, reportData, attType)
	} else {
		r1 = ret.Error(1)
	}
...
//   - reportData [64]byte
//   - attType int32
func (_e *Service_Expecter) Attestation(ctx interface{}, reportData interface{}, attType interface{}) *Service_Attestation_Call {
	return &Service_Attestation_Call{Call: _e.mock.On("Attestation", ctx, reportData, attType)}
}

func (_c *Service_Attestation_Call) Run(run func(ctx context.Context, reportData [64]byte, attType int32)) *Service_Attestation_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([64]byte), args[2].(int32))
	})
	return _c
}
...
func (_c *Service_Attestation_Call) RunAndReturn(run func(context.Context, [64]byte, int32) ([]byte, error)) *Service_Attestation_Call {
	_c.Call.Return(run)
	return _c
}

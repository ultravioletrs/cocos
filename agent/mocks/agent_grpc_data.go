...
type AgentService_DataClient[Req any, Res any] struct {
	mock.Mock
}

type AgentService_DataClient_Expecter[Req any, Res any] struct {
	mock *mock.Mock
}
...
type AgentService_DataClient_CloseAndRecv_Call[Req any, Res any] struct {
	*mock.Call
}
...
type AgentService_DataClient_CloseSend_Call[Req any, Res any] struct {
	*mock.Call
}
...
type AgentService_DataClient_Context_Call[Req any, Res any] struct {
	*mock.Call
}
...
type AgentService_DataClient_Header_Call[Req any, Res any] struct {
	*mock.Call
}
...
func (_m *AgentService_DataClient[Req, Res]) RecvMsg(m any) error {
	ret := _m.Called(m)
...
type AgentService_DataClient_RecvMsg_Call[Req any, Res any] struct {
	*mock.Call
}

// RecvMsg is a helper method to define mock.On call
//   - m any
func (_e *AgentService_DataClient_Expecter[Req, Res]) RecvMsg(m any) *AgentService_DataClient_RecvMsg_Call[Req, Res] {
	return &AgentService_DataClient_RecvMsg_Call[Req, Res]{Call: _e.mock.On("RecvMsg", m)}
}

func (_c *AgentService_DataClient_RecvMsg_Call[Req, Res]) Run(run func(m any)) *AgentService_DataClient_RecvMsg_Call[Req, Res] {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(any))
	})
	return _c
...
func (_c *AgentService_DataClient_RecvMsg_Call[Req, Res]) RunAndReturn(run func(any) error) *AgentService_DataClient_RecvMsg_Call[Req, Res] {
	_c.Call.Return(run)
	return _c
}
...
type AgentService_DataClient_Send_Call[Req any, Res any] struct {
	*mock.Call
}

// Send is a helper method to define mock.On call
//   - _a0 *agent.DataRequest
func (_e *AgentService_DataClient_Expecter[Req, Res]) Send(_a0 any) *AgentService_DataClient_Send_Call[Req, Res] {
...
func (_m *AgentService_DataClient[Req, Res]) SendMsg(m any) error {
	ret := _m.Called(m)
...
type AgentService_DataClient_SendMsg_Call[Req any, Res any] struct {
	*mock.Call
}

// SendMsg is a helper method to define mock.On call
//   - m any
func (_e *AgentService_DataClient_Expecter[Req, Res]) SendMsg(m any) *AgentService_DataClient_SendMsg_Call[Req, Res] {
	return &AgentService_DataClient_SendMsg_Call[Req, Res]{Call: _e.mock.On("SendMsg", m)}
}

func (_c *AgentService_DataClient_SendMsg_Call[Req, Res]) Run(run func(m any)) *AgentService_DataClient_SendMsg_Call[Req, Res] {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(any))
	})
	return _c
...
func (_c *AgentService_DataClient_SendMsg_Call[Req, Res]) RunAndReturn(run func(any) error) *AgentService_DataClient_SendMsg_Call[Req, Res] {
	_c.Call.Return(run)
	return _c
}
...
type AgentService_DataClient_Trailer_Call[Req any, Res any] struct {
	*mock.Call
}
...
func NewAgentService_DataClient[Req any, Res any](t interface {
	mock.TestingT
	Cleanup(func())

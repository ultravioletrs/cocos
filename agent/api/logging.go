...
func (lm *loggingMiddleware) Attestation(ctx context.Context, reportData [quoteprovider.Nonce]byte, nonce [vtpm.Nonce]byte, attType config.PlatformType) (response []byte, err error) {
	defer func(begin time.Time) {

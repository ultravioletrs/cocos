...
const (
	...
	AgentService_FetchAttestationResult_FullMethodName = "/agent.AgentService/FetchAttestationResult"
)
...
type AgentServiceClient interface {
	...
	FetchAttestationResult(ctx context.Context, in *FetchAttestationResultRequest, opts ...grpc.CallOption) (*FetchAttestationResultResponse, error)
}
...
func (c *agentServiceClient) FetchAttestationResult(ctx context.Context, in *FetchAttestationResultRequest, opts ...grpc.CallOption) (*FetchAttestationResultResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FetchAttestationResultResponse)
	err := c.cc.Invoke(ctx, AgentService_FetchAttestationResult_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AgentServiceServer interface {
	...
	FetchAttestationResult(context.Context, *FetchAttestationResultRequest) (*FetchAttestationResultResponse, error)
...
func (UnimplementedAgentServiceServer) FetchAttestationResult(context.Context, *FetchAttestationResultRequest) (*FetchAttestationResultResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FetchAttestationResult not implemented")
}
...
func _AgentService_FetchAttestationResult_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FetchAttestationResultRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AgentServiceServer).FetchAttestationResult(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AgentService_FetchAttestationResult_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentServiceServer).FetchAttestationResult(ctx, req.(*FetchAttestationResultRequest))
	}
...
var AgentService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "FetchAttestationResult",
			Handler:    _AgentService_FetchAttestationResult_Handler,
		},
	},

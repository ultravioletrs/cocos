...
type AlgoRequest struct {
	...
	ResultsFilePath []byte `protobuf:"bytes,3,opt,name=results_file_path,json=resultsFilePath,proto3" json:"results_file_path,omitempty"`
}
...
func (x *AlgoRequest) GetResultsFilePath() []byte {
	if x != nil {
		return x.ResultsFilePath
	}
	return nil
}
...
var file_agent_agent_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x05, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x22, 0x7b, 0x0a, 0x0b, 0x41, 0x6c,
	...
	0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x2a, 0x0a, 0x11, 0x72,
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x5f, 0x66, 0x69, 0x6c, 0x65, 0x5f, 0x70, 0x61, 0x74, 0x68,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0f, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x46,
	0x69, 0x6c, 0x65, 0x50, 0x61, 0x74, 0x68, 0x22, 0x0e, 0x0a, 0x0c, 0x41, 0x6c, 0x67, 0x6f, 0x52,

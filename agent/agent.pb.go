...
func (x *FetchAttestationResultRequest) Reset() {
	*x = FetchAttestationResultRequest{}
	mi := &file_agent_agent_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *FetchAttestationResultRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FetchAttestationResultRequest) ProtoMessage() {}

func (x *FetchAttestationResultRequest) ProtoReflect() protoreflect.Message {
	mi := &file_agent_agent_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FetchAttestationResultRequest.ProtoReflect.Descriptor instead.
func (*FetchAttestationResultRequest) Descriptor() ([]byte, []int) {
	return file_agent_agent_proto_rawDescGZIP(), []int{8}
}

func (x *FetchAttestationResultRequest) GetTokenNonce() []byte {
	if x != nil {
		return x.TokenNonce
	}
	return nil
...
func (x *FetchAttestationResultRequest) GetType() int32 {
	if x != nil {
		return x.Type
	}
	return 0
...
type FetchAttestationResultResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	File          []byte                 `protobuf:"bytes,1,opt,name=file,proto3" json:"file,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *FetchAttestationResultResponse) Reset() {
	*x = FetchAttestationResultResponse{}
	mi := &file_agent_agent_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *FetchAttestationResultResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FetchAttestationResultResponse) ProtoMessage() {}

func (x *FetchAttestationResultResponse) ProtoReflect() protoreflect.Message {
	mi := &file_agent_agent_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FetchAttestationResultResponse.ProtoReflect.Descriptor instead.
func (*FetchAttestationResultResponse) Descriptor() ([]byte, []int) {
	return file_agent_agent_proto_rawDescGZIP(), []int{9}
}

func (x *FetchAttestationResultResponse) GetFile() []byte {
	if x != nil {
		return x.File
	}
	return nil
...
var file_agent_agent_proto_rawDesc = string([]byte{
	...
	0x52, 0x04, 0x66, 0x69, 0x6c, 0x65, 0x22, 0x53, 0x0a, 0x1d, 0x46, 0x65, 0x74, 0x63, 0x68, 0x41,
	0x74, 0x74, 0x65, 0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1e, 0x0a, 0x0a, 0x74, 0x6f, 0x6b, 0x65, 0x6e,
	0x4e, 0x6f, 0x6e, 0x63, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0a, 0x74, 0x6f, 0x6b,
	0x65, 0x6e, 0x4e, 0x6f, 0x6e, 0x63, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0x34, 0x0a, 0x1e, 0x46,
	0x65, 0x74, 0x63, 0x68, 0x41, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52,
	...
	,
...
var file_agent_agent_proto_goTypes = []any{
	...
	(*FetchAttestationResultRequest)(nil),  // 8: agent.FetchAttestationResultRequest
	(*FetchAttestationResultResponse)(nil), // 9: agent.FetchAttestationResultResponse
}
var file_agent_agent_proto_depIdxs = []int32{
	...
	8, // 4: agent.AgentService.FetchAttestationResult:input_type -> agent.FetchAttestationResultRequest
	...
	9, // 9: agent.AgentService.FetchAttestationResult:output_type -> agent.FetchAttestationResultResponse
